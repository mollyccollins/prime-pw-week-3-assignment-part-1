...
let favoriteFoods= [ 'cheese' , 'avocado' , 'eggs', 'hoagies' , 'pizza'];
...
console.log('Number of favorite foods in array:', favoriteFoods.length);
...
console.log('Removed last favorite food' , removedFavFood);
